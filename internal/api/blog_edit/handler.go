...
func (h *Handler) BlogEditHandler(c *gin.Context) {
	...
	isSuccessful, errx := h.BlogCreateEditDAO.BlogCreateEdit(c, getDetails.Id, getDetails.Title, getDetails.Type, getDetails.Description)
